                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Membres
                     <span style="float: right;">
                        <button class="btn btn-primary" data-toggle="modal" data-target="#ProvinceModal"><i class="fas fa-plus-square mr-2"></i>Acteurs</button>
                    </span>
                        ...
                        <div class="card-body table-responsive">
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    <thead>
                                        ...
                                        <tr>
                                            <th>ID_Membre</th>
                                            <td><input type="text" name="id_membre" class="form-control w-75" required></td>
                                        </tr>
                                        <tr>
                                            <th>Nom_PostNom</th>
                                            <td><input type="text" name="nom_membre" class="form-control w-75" required></td>
                                        </tr>
                                        <tr>
                                            <th>Prenom</th>
                                            <td><input type="text" name="prenom_membre" class="form-control w-75" required></td>
                                        </tr>
                                        <tr>
                                            <th>Sexe</th>
                                            <td>
                                                <select class="form-control w-75" name="sexe_membre">
                                        ...
                                        <tr>
                                            <th>Niveau_Etude</th>
                                            <td>
                                            <select class="form-control w-75" name="etude_membre">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="date" name="naissance_membre" class="form-control w-75" required></td>
                                        </tr>
                                        <tr>
                                            <th>Date_Enregistrement</th>
                                            <td><input type="date" name="enregistrement" class="form-control w-75"></td>
                                        </tr>
                                        <tr>
                                            <th>Num_Phone</th>
                                            <td><input type="text" name="phone" class="form-control w-75" required></td>
                                        </tr>
                                        <tr>
                                            <th>ID_Categorie</th>
                                            <td>
                                                <select name="categorie_membre" class="form-control w-75">
                                             <?php 
            $sql_acteur = "select * from acteurs";
                        $res_acteur = mysqli_query($con, $sql_acteur);
                        while($row = mysqli_fetch_assoc($res_acteur)){$acteur = true;
                                        ?>   
                                     ...
                                     <?php }?>
                                        ...
                                        <tr>
                                            <th>ID_Lieu</th>
                                            <td>
                                                <select name="lieu_membre" class="form-control w-75">
                                             <?php 
            $sql_lieux = "select * from lieux";
                        $res_lieux = mysqli_query($con, $sql_lieux);
                        while($row = mysqli_fetch_assoc($res_lieux)){$lieux = true;
                                        ?>   
                                     ...
                                     <?php }?>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="association_membre" class="form-control w-75"></td>
                                        </tr>
                                        
                                        <tr><td></td>
                                         <td>
                                       <?php 
                                       if (isset($acteur) and isset($lieux)) {?>
                                          
                                        <button class="btn btn-primary" type="submit" name="member"> Enregistre</button>
                                      <?php }?>
                                    </td>
                                        </tr>
                                    </thead>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-plus-square mr-2"></i>Ajoute acteurs</h5>
                ...
                <div class="modal-body">
                    <form method="POST" class="form-group" >
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            <th>Categorie</th>
                                            <td><input type="text" name="categorie" class="form-control w-75" required></td>
                                        </tr>
                                    
                                        <tr><td></td>
                                         <td><button class="btn btn-primary" type="submit" name="cate"> Enregistre</button></td>
                                        </tr>
                                    </thead>
                                </table>
                            </form>
...
<?php
if (isset($_POST['cate'])) {
    $id_ac = mysqli_escape_string($con, $_POST['id']);
    $categorie = mysqli_escape_string($con, $_POST['categorie']);
    $sql_prov = "insert into acteurs values('$id_ac','$categorie')";
    $res_pro = mysqli_query($con, $sql_prov);
    if ($res_pro) {
        echo "<script>alert('Acteurs ajouter avec success')</script>";
    }
}


if (isset($_POST['member'])) {
    $id = mysqli_escape_string($con, $_POST['id_membre']);
    $nom = mysqli_escape_string($con, $_POST['nom_membre']);
    $prenom = mysqli_escape_string($con, $_POST['prenom_membre']);
    $sexe = mysqli_escape_string($con, $_POST['sexe_membre']);
    $etude = mysqli_escape_string($con, $_POST['etude_membre']);
    $naissance = mysqli_escape_string($con, $_POST['naissance_membre']);
    $enregistrement = mysqli_escape_string($con, $_POST['enregistrement']);
    $phone = mysqli_escape_string($con, $_POST['phone']);
    $cate = mysqli_escape_string($con, $_POST['categorie_membre']);
    $lie = mysqli_escape_string($con, $_POST['lieu_membre']);
    $association = mysqli_escape_string($con, $_POST['association_membre']);
    $month = date('m');
    $year = date('Y');
    
    $sql_client = "insert into membres values('$id','$nom','$prenom','$sexe','$etude','$naissance','$enregistrement','$phone','$cate','$lie','$association','$month','$year')";
    //echo $id.$nom.$prenom.$sexe.$etude.$naissance.$enregistrement.$phone.$cate.$lie.$association;
    $res_client = mysqli_query($con, $sql_client) or die('<script>alert("sorry dear")</script>');
    if ($res_client) {
        echo "<script>alert('Membre ajouter avec success')</script>";
    }
}
?>