                        ...
                        <div class="card-body table-responsive">
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    <thead>
                                        ...
                                        <tr>
                                            <th>Saison_A</th>
                                            <td><input type="text" name="saison_a" class="form-control w-75" required></td>
                                        </tr>
                                        <tr>
                                            <th>Saison_B</th>
                                            <td><input type="text" name="saison_b" class="form-control w-75"></td>
                                        </tr>
                                        <tr>
                                            <th>Saison_C</th>
                                            <td><input type="text" name="saison_c" class="form-control w-75"></td>
                                        </tr>
                                        <tr><td></td>
                                         <td><button class="btn btn-primary" type="submit" name="produit_submit"> Enregistre</button></td>
                                        </tr>
                                    </thead>
                                </table>
                              </form>
...
<?php
if (isset($_POST['produit_submit'])) {
    $id = mysqli_escape_string($con, $_POST['id']);
    $nom = mysqli_escape_string($con, $_POST['nom']);
    $saison_a = mysqli_escape_string($con, $_POST['saison_a']);
    $saison_b = mysqli_escape_string($con, $_POST['saison_b']);
    $saison_c = mysqli_escape_string($con, $_POST['saison_c']);
    
    $sql_ = "insert into produits values('$id','$nom','$saison_a','$saison_b','$saison_c')";
    $res_ = mysqli_query($con, $sql_)or die('sorry dear');
    if ($res_) {
        echo "<script>alert('Produit ajouter avec success')
        </script>";
    }
}
?>