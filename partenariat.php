        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tracking livraison<a href="addpartenariat.php" class="btn btn-primary" style="float:right">Ajouter</a></a></h1>
                    <br>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4" style="border:1px solid lightgray;">
                        ...
                        <div class="card-body table-responsive">
                                <table class="table  table-bordered" id="dataTable">
                                    <thead>
                                        <tr><th colspan="5">Partenariat Individuel</th></tr>
                                        <tr>
                                            <th>Nom</th>
                                            <th>Pre-nom</th>
                                            <th>Adress</th>
                                    ...
                                    <tbody>
                                        <?php
          $sql = "select * from partenariat_in";
         ...
         ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row['date_par'];?></td>
                                        </tr>
                                    <?php }?>
                                    </tbody>

                                    <thead>
                                        <tr><th colspan="5">Partenariat Company</th></tr>
                                        <tr>
                                            <th>Denomination</th>
                                            <th>Nom</th>
                                            <th>Adress</th>
                                    ...
                                    <tbody>
                                        <?php
          $sql = "select * from partenariat_com";
          $res = mysqli_query($con, $sql)or die('sorry dear program');
          while ($row = mysqli_fetch_assoc($res)) {
         //for error occur when admin remove folder inside the server
         ?>
