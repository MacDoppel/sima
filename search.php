...
if(isset($_POST['search'])){
          $id = $_POST['data'];
          $sql = "select * from tbl_member where register='$id'";
          $res = mysqli_query($con, $sql)or die('sorry dear program');
          while ($row = mysqli_fetch_assoc($res)) {
          $found = true;
          $name = $row['pname']." ".$row['name']." ".$row['lname'];
...
<head>
  ...
  <link rel="icon" type="image/png" sizes="32x32" href="../../assets/fevicon/favicon.ico">
    ...
    <title>Fondation La Vie Est Belle</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">FVB Admin</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          include("db_conf.php");
          $sql = "select * from tbl_notification where state_notify='UNREAD' order by date_notify desc limit 5";
          $res = mysqli_query($con, $sql)or die('sorry dear program');
          while ($row = mysqli_fetch_assoc($res)) {
         ?>
                                <a class="dropdown-item d-flex align-items-center" href="<?php echo $row['url_notify'];?>">
                                    <div class="mr-3">
                                        <div class="icon-circle bg-primary">
                                            <?php 

                                            if ($row['url_notify'] == 'contact.php') {
                                                echo '<i class="fas fa-file-alt text-white"></i>';
                                            }

                                            if ($row['url_notify'] == 'donateur.php') {
                                    ...
                                    <div>
                                        <div class="small text-gray-500"><?php echo $row['date_notify'];?></div>
                                        <span class="font-weight-bold"><?php echo $row['msg_notify'];?></span>
                                    </div>
                                </a>
                            <?php }?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" style="border:1px solid lightgray;">
                        <div class="card-header py-3" style="border-bottom:1px solid lightgray;">
                            <h6 class="m-0 font-weight-bold text-primary">Membres details<button style="float:right" class="btn btn-primary"
                         ><a class="text-white" style="text-decoration: none;"
                          <?php

          if (isset($found)) {
               echo "href='qr/card.php?card=$id'";
           } else{
            echo "href='#' title='Pardon pay votre inscription'";
           }
                                   

                          ?>
                         >
                         <i class="fas fa-id-card"></i>&nbsp;Card</a></button></h6>
                        </div>
                    ...
                    <table class="table table-bordered"  width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Profile</th>
                                            <th colspan="2">Membre detail</th>
                                            </tr>
                                    </thead>
                                    
                                    <tbody>
                                    <tr>
                                     <td rowspan="13"><img src='<?php echo "../../member/".$profile_membre;?>' width="450" height="450"></td>
                                     <th>Nom :</th>
                                     <td><?php echo $name;?></td>
                                 </tr>
                                 <tr>
                                    ...
                                    <?php
                                     ...
                                     $sql_p = "select register_member from tbl_payment where register_member='$register'";
          $res_p = mysqli_query($con, $sql_p)or die('sorry dear program');
          if (mysqli_num_rows($res_p) > 0) {
               echo "<i class='fas fa-check-circle text-primary' style='font-size: 25px;'></i>";
           } else{
            echo "<i class='fas fa-times-circle text-danger' style='font-size: 25px;'></i>";
           }
                                    ?></td>
                                     </tr>  
                                    </tbody>
                            ...
                            <?php }else{echo "<h3><i class='fas fa-laugh-wink' style='color: #0fce45'></i>&nbsp;Ouf membre n'est pas trouver !!!</h3>";}?>
                        </div>
                    </div>
